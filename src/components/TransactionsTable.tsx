 ...
 function parseDateSafe(dateStr: string): Date | null {
  ...
  // Último intento (por si viene algo raro pero parseable)
...
function monthKey(dateStr: string) {
  ...
  export function TransactionsTable({ 
    ...
    const controlBase ="rounded-xl px-3 py-2 text-sm outline-none backdrop-blur-xl transition " + "bg-white/10 text-white ring-1 ring-white/20 " +
    ...
    const optionClass = "bg-[#0B1020] text-white"; // mejora el dropdown abierto (cuando el navegador lo respeta)
    ...
    return (
      <motion.div
        ...
        <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="grid w-full grid-cols-1 gap-3 md:w-auto md:grid-cols-[280px_170px_140px] md:items-center md:justify-end">
            <input
            value={search}
            ...
            <div className={selectWrap}>
              <select
                ...
                <option className={optionClass} value="Todos">Todos los meses</option>
                {months.map((m) => (
            ...
            <div className={selectWrap}>
                ...
                >
                  ...
                  <option className={optionClass} value="Ingreso">Ingreso</option>
                  <option className={optionClass} value="Gasto">Gasto</option>
                </select>
        ...
        <div className="overflow-x-auto rounded-2xl ring-1 ring-white/10">
          <table className="min-w-full text-sm">
            ...
            <tbody>
                {filtered.map((t, i) => {
                  const isIngreso = (t.Tipo ?? "").trim().toLowerCase() === "ingreso";
